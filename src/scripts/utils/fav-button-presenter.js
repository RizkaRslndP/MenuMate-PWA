...
} from '../views/template/favorite-button-template';
import { INIT_SWAL_SUCCESS, INIT_SWAL_ERROR } from './swal2-initiator';
...
const FAV_BUTTON_PRESENTER = {
  ...
  _renderFavButtonTemplate() {
    ...
    favButton.addEventListener('click', async () => {
      await this._favoriteResto.addRestaurant(this._resto);
